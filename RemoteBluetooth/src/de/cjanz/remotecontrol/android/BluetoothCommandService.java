...
import de.cjanz.remotecontrol.android.RemoteControlActivity.BluetoothMessageHandler;
...
public class BluetoothCommandService {
	...
	private synchronized void setState(int state) {
		...
		Message message = mHandler.obtainMessage(
				BluetoothMessageHandler.MESSAGE_STATE_CHANGE, state, -1);

		message.getData().putString(BluetoothMessageHandler.DEVICE_NAME,
				getDeviceName());
		...
		public void run() {
			...
			while (true) {
				try {
					...
					mHandler.obtainMessage(BluetoothMessageHandler.MESSAGE_READ,
